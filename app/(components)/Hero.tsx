...
function Hero() {
  ...
  return (
    <motion.div className="" variants={containerVariants} initial="hidden" animate="visible">
      ...
      <motion.p className='pl-2 md:pl-[12px] text-[18px] md:text-[26px] lg:text-[32px] h-light tracking-wider' variants={textVariants}>WEBSITES AROUND THE WORLD</motion.p>
    </motion.div>
  )
}
